...
func GetENV(experimentDetails *experimentTypes.ExperimentDetails) {
	...
	experimentDetails.ChaosServiceAccount = types.Getenv("CHAOS_SERVICE_ACCOUNT", "litmus-admin")
	...
	experimentDetails.ServiceName = types.Getenv("SERVICE_NAME", "")
	experimentDetails.HostName = types.Getenv("HOSTNAME", "")
